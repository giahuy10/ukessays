...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="{{route('customer.index')}}"><em class="fa fa-calendar">&nbsp;</em> Students</a></li>
			<li><a href="{{route('teacher.index')}}"><em class="fa fa-bar-chart">&nbsp;</em> Writers</a></li>
			<li><a href="{{route('order.index')}}"><em class="fa fa-toggle-off">&nbsp;</em> Orders</a></li>
			<li><a href="{{route('admin.finance')}}"><em class="fa fa-clone">&nbsp;</em> Finance</a></li>
			<li><a href="{{route('admin.message')}}"><em class="fa fa-clone">&nbsp;</em> Messages</a></li>
			<li class="parent "><a data-toggle="collapse" href="#sub-item-1">
				<em class="fa fa-navicon">&nbsp;</em> Settings <span data-toggle="collapse" href="#sub-item-1" class="icon pull-right"><em class="fa fa-plus"></em></span>
				</a>
