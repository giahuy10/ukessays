...
@endsection
@section('content')
    <form class="form-horizontal" action="{{route('writerlevel.store')}}" method="post">
        @csrf
        <fieldset>
            <!-- Name input-->
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input id="maximum_order" name="maximum_order" type="text" placeholder="Maximum Order" class="form-control">
                </div>
            </div>
            <!-- Rated input-->
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input id="rated" name="rated" type="text" placeholder="Rated" class="form-control">
                </div>
            </div>
            <!-- Message body -->
            <div class="form-group">
