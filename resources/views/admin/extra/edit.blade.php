...
@endsection
@section('content')
    <form class="form-horizontal" action="{{route('extra.update',['extra'=>$item->id])}}" method="POST">
        @csrf
        @method('PUT')
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input id="name" name="price" type="text" value="{{$item->price}}" placeholder="Price" class="form-control">
                </div>
            </div>
            <!-- Message body -->
            <div class="form-group">
